...
$logFile   = "$logDir\weekly-$timestamp.log"
$cmdFile   = Join-Path $env:USERPROFILE '.claude\commands\obsidian-review.md'
$vault     = $env:OBSIDIAN_VAULT_PATH
$claudeExe = Join-Path $env:USERPROFILE '.local\bin\claude.exe'
$prompt    = "Read $cmdFile and carry out its instructions exactly. Vault: $vault. Today: $today. Generate a weekly review. Run headlessly, no questions, save and stop."
